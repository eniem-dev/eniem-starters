export const env = {
  ...
  email: {
    ...
    fromAddress: process.env.EMAIL_FROM_ADDRESS || "no-reply@eniem-feeback-collect-saas.example.com",
  ...
  support: {
    email: process.env.SUPPORT_EMAIL || process.env.EMAIL_FROM_ADDRESS || "support@eniem-feeback-collect-saas.example.com",
  },
} as const;
